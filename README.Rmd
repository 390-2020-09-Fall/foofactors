...
Factors are a very useful type of variable in R, but they can also be very aggravating. This package provides some helper functions for the care and feeding of factors. In addition, this package provides a function that tests for the parity of a specified numeric vector.
...
We can test if a numeric value is even. The result will be a logical vector.
